...
#define MCLK_441           (2*512*44100)   /* 44.1, 88.2 etc */
#define MCLK_48            (2*512*48000)   /* 48, 96 etc */
#else
...
#define DFU_FLASH_DEVICE FL_QUADDEVICE_W25Q16JW
